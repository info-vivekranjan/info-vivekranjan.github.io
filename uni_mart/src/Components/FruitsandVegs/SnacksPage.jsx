...

            {
                ...
                <div className={styles.fruitsvegsPageCont}>
                    ...
                    <div className={styles.fruitsvegsPageRight}>
                        ...
                        <button className={styles.count} className={styles.count} disabled={itemCount[data.id] === 1 || itemCount[data.id] === undefined} onClick={() => handleDecrement(data.id)}>-</button>
                        <sapn>{itemCount[data.id] || 1}</sapn>
                        <button className={styles.count} className={styles.count} onClick={() => handleIncrement(data.id)}>+</button>
